...
![](images/Screenshot%201405-03-18%20at%2016.41.40.png)

اول از همه ما یک سری داده داریم که در جدول زیر مشخص شده است.

![](images/Screenshot%201405-03-17%20at%2010.21.52.png)
...
## ![](images/clipboard-2402769530.png)

![](images/clipboard-1058952336.png)

جدول مربوطه:

![](images/clipboard-1226860636.png)

تابع likelihood برای زمانی که سانسور به صورت بازه ای است به اینصورت خواهد بود: $$l(\lambda, \beta) = \sum_{i=1}^{k}r_iln[e^{-(\lambda t_{i-1}^{\beta} - e^{-(\lambda t_i)^\beta})}] - \sum_{i=1}^{k} m_i (\lambda t_i)^\beta$$
