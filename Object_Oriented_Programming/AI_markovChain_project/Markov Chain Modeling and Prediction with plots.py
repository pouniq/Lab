...
def plot_simulated_sequence_counts(states, sequence):
    """
    Create a countplot for the simulated sequence.
    """
    plt.figure(figsize=(8, 5))
    sns.countplot(x=sequence, order=states, palette="coolwarm")
    plt.xlabel("State")
    plt.ylabel("Count")
    plt.title("Count of Each State in Simulated Sequence")
    plt.tight_layout()
    plt.show()
...
def main():
    ...
    plot_simulated_sequence_counts(STATES, simulated_sequence) 
